...
$stmt = mysqli_prepare($link, "SELECT id, label, active FROM validation_links WHERE token = ?");
                ...
                <div class="auth-full-page-content d-flex p-sm-5 p-4">
                    <div class="w-100">
                        ...
                        <?php else: ?>
                            ...
                            <?php mysqli_data_seek($pending, 0); $anyPending = false; while ($p = mysqli_fetch_assoc($pending)): ?>
                                <?php if ($p["status"] !== "pendiente"): continue; endif; $anyPending = true; ?>
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <form method="post" class="row g-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="ciudad" class="form-control" value="<?php echo htmlspecialchars($p['ciudad'] ?? ''); ?>">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="notes" class="form-control" value="<?php echo htmlspecialchars($p['notes'] ?? ''); ?>">
                                            </div>
                                            <div class="col-md-6">
